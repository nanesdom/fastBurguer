...
function variable(){
	...
	variableAjax.open('POST', 'php/sesion.php');
...
function variable2(){
	...
	variable2Ajax.open('POST', 'php/sesion2.php');
...
function carrito(){
	...
	carritoAjax.open('POST', 'php/carrito.php');
...
function salir(){
	...
	variableAjax = new XMLHttpRequest();
	variableAjax.open('POST', 'php/salir.php');
...
function pedir(){
	...
	lugarAjax.open('POST', 'php/lugar.php');
...
function agregar(){
		...
		if (nombreEspecialidad == "" || precio == "" || descripcion == "" || file == null) {
			...
			agregar.open('POST', 'php/agregarEspecialidad.php');
...
function agregar2(){
		...
		if (nombreCombo == "" || precio == "" || descripcion == "" || file == null) {
			...
			agregar = new XMLHttpRequest();
			agregar.open('POST', 'php/agregarCombo.php');
...
function agregar3(){
		...
		if (nombreIngrediente == "" ||  file == null) {
			...
			agregar = new XMLHttpRequest();
			agregar.open('POST', 'php/agregarIngrediente.php');
...
function cargarCombos(){
	...
	cargarCombosAjax = new XMLHttpRequest();
			...
			cargarCombosAjax.open('POST', 'php/combos.php');
...
function cargarEspecialidades(){
	...
	cargarEspecialidadesAjax = new XMLHttpRequest();
			...
			cargarEspecialidadesAjax.open('POST', 'php/especialidades.php');
...
function comprarEspecialidad(id, nombre, cantidad, precio, descripcion){
	...
	if (c == 0) {
		...
		comprarEspecialidadAjax.open('POST', 'php/comprarEspecialidad.php');
...
function comprarCombo(id, nombre, cantidad, precio, descripcion){
	...
	if (c == 0) {
		...
		comprarComboAjax.open('POST', 'php/compraCombo.php');
...
function cargarIngredientes(){
	...
	cargarIngredientesAjax = new XMLHttpRequest();
			...
			cargarIngredientesAjax.open('POST', 'php/ingredientes.php');
...
function agregarHambur(){
	...
	if (precio == 0) {
		...
		comprarHambur.open('POST', 'php/comprarHambur.php');
...
function cargarCarrito(){
	...
	cargarEspe.open('POST', 'php/cargarEspe.php');
	...
	cargarComboAjax.open('POST', 'php/cargarCombo.php');
	...
	cargarHamburguesa.open('POST', 'php/cargarHamburguesa.php');
	...
	miCarrito = new XMLHttpRequest();
			miCarrito.open('POST', 'php/miCarrito.php');
...
function comprar(){
	...
	comprarAjax.open('POST', 'php/comprarAjax.php');
...
function ventas(){
	...
	ventasAjax.open('POST', 'php/ventas.php');
